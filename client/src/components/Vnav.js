...
function Hnav(){
    ...
    <span class="navbar-toggler-icon"></span>
            ...
            <li class= "nav-item ">
                         <button onClick={handleHome} style={{ color: 'white' }} class="btn btn-custom fs-5">{language ? 'Accueil Bénévole' : 'Volunteer home'}</button>
                        </li>
                        <li class= "nav-item ">
                        ...
                        <div class="btn-group" role="group">
                                        <button type="button" class="btn dropdown-toggle fs-5" style={{color: 'white'}} data-bs-toggle="dropdown" aria-expanded="false">
