...
function Formvegetables(){
    ...
    const handleSubmit = async (e) => {
        ...
        .then(  res => {
            if(state.family){
                if(res.data[0].sum > category[0].maximum_f){
    ...
    return(
        <section>
            ...
            <section><h2 class="text-danger">{empty? 'We are out of vegetables' : <>Max {maximum} Vegetables ({maximumf} for families)</>}</h2></section>
